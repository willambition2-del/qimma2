  ...
  return (
    <>
      ...
      <PageHeader badge="أنظمة مخصصة"
        title="برمجة خاصة وتطوير البرمجيات"
        description="نحن شركة تصميم برامج وأنظمة سحابية تقدم خدمات تصميم البرمجيات المتقدمة، وتطوير البرامج المخصصة، وبرمجة تطبيقات الويب لمؤسستك."
            ...
            <ScrollReveal>
              <div>
                ...
                <p className="text-muted leading-relaxed mb-6">
                  البرامج الجاهزة قد لا تغطي كافة متطلبات شركتك وتجبرك على التنازل عن بعض تفاصيل دورتك التشغيلية. مع خدمات تطوير البرمجيات المخصصة والبرمجة خاصة من قمة، نصمم لك حلولاً برمجية متكاملة تغطي 100% من احتياجاتك.
                </p>
                <p className="text-muted leading-relaxed mb-8">
                  بصفتنا شركة تطوير برمجيات رائدة، نركز على دمج البرمجه والتطبيقات لربط الفروع، وإدارة المستودعات، وتنظيم شؤون الموظفين، وبناء نظامك بشكل مرن، آمن، وقابل للتوسع المستقبلي بسهولة.
                </p>
