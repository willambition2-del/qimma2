  ...
  return (
    <>
      ...
      <PageHeader badge="تطبيقات ذكية"
        ...
        description="نحن شركة تطبيقات تقدم خدمات تصميم تطبيقات جوال متكاملة وتطوير تطبيقات الجوال لنظامي iOS و Android بأعلى معايير السرعة والأمان."
            ...
            <ScrollReveal>
              <div>
                ...
                <p className="text-muted leading-relaxed mb-6">
                  تصميم تطبيقات جوال وتطويرها في قمة يبدأ من فهم دقيق لسلوك عملائك. بصفتنا شركة تطوير تطبيقات متميزة، نركز على برمجه تطبيق الجوال ليكون سريع الاستجابة ومريحاً للمستخدم.
                </p>
                <p className="text-muted leading-relaxed mb-8">
                  سواء كنت تبحث عن شركات تطبيقات متخصصة أو مبرمج تطبيقات ذكي، فإننا نضمن لك تقديم أفضل تطوير تطبيق لمتجرك أو شركتك وتطوير تطبيقات تناسب طموحاتك وميزانيتك.
                </p>
